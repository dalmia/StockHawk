...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public static final String INTENT_PERIODIC = "periodic";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mServiceIntent.putExtra(INTENT_TAG, INTENT_INIT);
            if (isConnected(this)) {
                                ...
                                public void onInput(MaterialDialog dialog, CharSequence input) {
                                    ...
                                    if(c!=null) {
                                        if (c.getCount() != 0) {
                                            ...
                                            // Add the stock to DB
                                            mServiceIntent.putExtra(INTENT_TAG, INTENT_ADD);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        intent.putExtra(StockDetailFragment.STOCK_SYMBOL, v.getTag().toString());
    ...
    public void setupPeriodicGCMTasks(){
        if (isConnected(this)) {
            long period = 3600L;
            long flex = 10L;
            String periodicTag = INTENT_PERIODIC;
